...
//2 requireComponent cs chuc nang lam cho k the remove Rigidbody va SphereCollider 
...
public class BulletImpart : BulletAbstract
{
    ...
    protected virtual void OnTriggerEnter(Collider other)
    {
      ...
      //  this.CreateImpact(other);
    }
    //protected virtual void CreateImpact(Collider other)
    //{
