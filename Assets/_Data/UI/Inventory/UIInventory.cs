...
public class UIInventory : UIInventoryAbstract
{
    ...
    {
        this.inventoryController.gameObject.SetActive(true);
        this.isOpen = true;
    }

    public virtual void Close()
    {
        this.inventoryController.gameObject.SetActive(false);
        this.isOpen = false;
    }
    ...
    protected virtual void ShowItems()
    {
        ...
        UIInvItemSpawner spawner = this.inventoryController.UIInvItemSpawner;
    ...
    {
        this.inventoryController.UIInvItemSpawner.ClearItems();
    }
        ...
        for (int i = 0; i < itemCount - 1; i++)
        {
            ...
            switch (this.inventorySort)
            {
                case InventorySort.ByName:
                    ...
                    //if(compare ==1) isSwap = true;  
                    isSwap = string.Compare(currentName, nextName) == 1; // = 2 dong tren
