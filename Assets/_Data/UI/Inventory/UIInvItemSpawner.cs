...
public class UIInvItemSpawner : Spawner
{
    ...
    [SerializeField] protected UIInventoryController inventoryCtrl;
    public UIInventoryController UIInventoryCtrl => inventoryCtrl;
    ...
    protected virtual void LoadUIInventoryCtrl()
    {
        ...
        this.inventoryCtrl = transform.parent.GetComponent<UIInventoryController>();
